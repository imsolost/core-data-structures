...
describe('LinkedList', () => {
  ...
  context('insert()', () => {
    it('inserts a node with the provided data to the tail of the list.', () => {
      ...
      expect( linkedListA.tail.data ).to.equal( 'frapple' )
    })
  })
  ...
  context('insertFirst()', () => {
    it('inserts a node with the provided data to the head of the list.', () => {
      ...
      expect( linkedListA.head.data ).to.equal( 'zero' )
    })
  })
  ...
  context('getHeadNode()', () => {
    it('gets the data of head node.', () => {
      ...
      expect( linkedListA.getHeadNode().data ).to.equal( 'zero' )
    })

    it('gets the data of the next node from the head.', () => {

      expect( linkedListA.getHeadNode().next.data ).to.equal( 'apple' )
    })
  })
  ...
  context('getTailNode()', () => {
    it('gets data of the the tail node.', () => {
      ...
      expect( linkedListA.getTailNode().data ).to.equal( 'frapple' )
    })
  })
  ...
  context('contains()', () => {
    it('determines whether or not the list contains "elephant".', () => {
      ...
      expect( linkedListA.contains('elephant') ).to.equal( true )
    })

    it('determines whether or not the list contains "monkey".', () => {

      expect( linkedListA.contains('monkey') ).to.equal( false )
    })
  })
  ...
  context('find()', () => {
    it('returns the first node containing "banana".', () => {
      ...
      expect( linkedListA.find('banana').data ).to.equal( 'banana' )
    })

    it('returns -1 if it cannot find the data.', () => {
      expect( linkedListA.find('monkey') ).to.equal( -1 )
  ...
  context('insertAfter()', () => {
    ...
    it('inserts data "end" after node containing data "frapple"', () => {
      ...
      expect( linkedListA.tail.data ).to.equal( 'end' )
    })
  })
  ...
  context('size()', () => {
    it('returns the size of the list.', () => {
      ...
      expect( linkedListA.size ).to.equal( 9 )
    })
  })
  ...
  context('clear()', () => {
    it('should have a size of 0.', () => {
      linkedListA.clear()
      expect( linkedListA.size ).to.equal( 0 )
    })

    it('should have no head.', () => {

      expect( linkedListA.head ).to.equal( null )
    })
  })
  ...
  context('isEmpty()', () => {
    it('determines if the list is empty or not.', () => {
      ...
      expect( linkedListA.isEmpty() ).to.equal( true )
    })
  })
